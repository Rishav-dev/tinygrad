...
from typing import Tuple, List, Dict, Set, DefaultDict, Union, get_args
...
def _graph_schedule(outs:List[LazyBuffer]) -> Tuple[DefaultDict[LazyBuffer, List[LazyBuffer]], DefaultDict[LazyBuffer, int],
